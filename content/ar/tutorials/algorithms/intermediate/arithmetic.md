...
description: شرح العمليات الحسابية (Arithmetic Operations) في البرمجة بشكل مفصّل 
position: 6
...
### العمليات اﻷساسية
درسنا هذه العمليات من قبل، وهي العمليات الحسابية اﻷساسية...

|الاسم|العملية الحسابية|
|:--------:|:-------:|
|**علامة الجمع**| **`+`** |
|**علامة الطرح**| **`-`** |
|**علامة الضرب**| **`*`** |
